...
@section('container')
    <div class="w-full mx-auto px-4 py-6">
        {{-- Header --}}
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Laporan Setoran Harian</h1>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 mb-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold text-gray-800">{{ $cabang->nama_cabang ?? '-' }}</p>
                </div>
                <div>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-2">
                    <p><span class="text-gray-500">Saldo Awal Kas:</span>
                        <span class="font-semibold">Rp {{ number_format($saldoAwalKas, 0, ',', '.') }}</span>
                    </p>
                    <p><span class="text-gray-500">Tambahan Kas:</span>
                        <span class="font-semibold">Rp {{ number_format($tambahanKas, 0, ',', '.') }}</span>
                    </p>
                    <p><span class="text-gray-500">Pengurangan Kas:</span>
                        <span class="font-semibold">Rp {{ number_format($penguranganKas, 0, ',', '.') }}</span>
                    </p>
                </div>
                <div class="space-y-2">
                    <p><span class="text-gray-500">Total Transfer:</span>
                        <span class="font-semibold">Rp {{ number_format($totalTransfer, 0, ',', '.') }}</span>
                    </p>
                    <p><span class="text-gray-500">Total Tarik Tunai:</span>
                        <span class="font-semibold">Rp {{ number_format($totalTarikTunai, 0, ',', '.') }}</span>
                    </p>
                    <p class="text-green-600 font-bold">Saldo Akhir Kas:
                        Rp {{ number_format($saldoAkhirKas, 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
