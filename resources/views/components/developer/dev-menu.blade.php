<x-sidebar-menu label="Dashboard" route="developer.dashboard" active="developer.dashboard" icon="dashboard" />
<x-sidebar-menu label="Kelola Paket" route="developer.paket.index" active="developer.paket.*" icon="packet-dev" />
