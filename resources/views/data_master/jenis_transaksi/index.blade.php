...
@section('container')
    <div class="mt-5">
        <div class="flex justify-between items-center mb-4">
            <h1 class="text-xl font-bold">Data Jenis Transaksi</h1>
            <!-- Button Tambah -->
                ...
                <tbody>
                    @forelse ($jenisTransaksi as $i => $item)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">{{ $item->nama_transaksi }}</td>
                            ...
                            <td class="px-6 py-4 flex gap-2">
                                ...
                                <form action="{{ route('data_master.jenis-transaksi.destroy', $item->id) }}" method="POST"
                        ...
                        <div id="edit-modal-{{ $item->id }}" tabindex="-1" aria-hidden="true"
                            class="hidden fixed inset-0 z-50 items-center justify-center overflow-y-auto overflow-x-hidden flex">
                            <div class="relative w-full max-w-md p-4">
                                <div class="bg-white rounded-lg shadow dark:bg-gray-700">
                                    <div class="flex justify-between items-center p-4 border-b">
                                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Edit Jenis Transaksi
                                        </h3>
                                    ...
                                    <form action="{{ route('data_master.jenis-transaksi.update', $item->id) }}"
                                        ...
                                        <div class="p-4 space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <textarea name="keterangan" rows="3" class="w-full mt-1 p-2 border rounded-lg dark:bg-gray-600 dark:text-white">{{ $item->keterangan }}</textarea>
                                            </div>
                                        </div>
    ...
    <div id="tambah-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-md p-4">
            <div class="bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="flex justify-between items-center p-4 border-b">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Tambah Jenis Transaksi</h3>
                    <button type="button" class="text-gray-400 hover:bg-gray-200 rounded-lg p-1.5"
                ...
                <form action="{{ route('data_master.jenis-transaksi.store') }}" method="POST">
                    @csrf
                    <div class="p-4 space-y-4">
                        <div>
                            <label for="nama_transaksi"
